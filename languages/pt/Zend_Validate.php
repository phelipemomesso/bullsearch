...
return array(
    ...
    "'%value%' is an empty string" => "'%value%' é uma string vazia",
	"'%value%' contains characters which are not digits; but only digits are allowed" => "Apenas números são permitidos",
    ...
    "The two given tokens do not match" => "Os campos não possuem valores iguais",
    ...
    // Zend_Validate_Regex
    "Invalid type given, value should be string, integer or float" => "Tipo especificado inválido, o valor deve ser string, inteiro ou float",
    "'%value%' does not match against pattern '%pattern%'" => "'%value%' não corresponde ao padrão de telefone fixo",

...
function ImageFlow ()
{
	...
	this.defaults =
	{
		...
		aspectRatio:        2.000,          /* Aspect ratio of the ImageFlow container (width divided by height) */
		...
		imagesHeight:       0.4,           /* Height of the images div container in percent */
		imagesM:            1.0,            /* Multiplicator for all images in percent */
		onClick:            function() { 

			jQuery.ajax({

            url: baseUrl+'/result/detailscover',
            data: { 
